...
@Entity
@Table(name = "map")
public class GameMap extends BaseElement{
    ...
    @CollectionTable(name = "gate", joinColumns = @JoinColumn(name = "this_map_id"))
    @Column(name = "next_map_id")
    ...
    public String showPlayer () {
        ...
        for (Map.Entry<Integer, Player> entry: mapPlayers.entrySet()) {
