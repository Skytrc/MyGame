package com.fung.server.util.maputil;

import com.fung.server.content.entity.BaseElement;
...
public class MapInfoUtil {
    ...
    public String showMapOnlinePlayer(GameMap gameMap) {
        ...
        for (Map.Entry<Integer, Player> entry: gameMap.getMapPlayers().entrySet()) {
